        ...
        <>
            <Navbar id='footer' className='row mx-auto' collapseOnSelect fixed='bottom' expand="lg" bg="light" variant="light">
                <Navbar.Brand className='mx-auto text-center'>
                    ...
                    <span id='logos1' className='rounded-lg no1 text-center m-0' onClick={() => window.open("https://www.instagram.com/thephotoboothninja/", "_blank")}><i id='logos11' className="rounded-lg ml-3 mr-3 fab fa-instagram"></i></span>
