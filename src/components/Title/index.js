            ...
            <Navbar className='row' collapseOnSelect fixed='top' expand="lg" bg="white" variant="white">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        <Nav.Link id='callUs' className='ml-2'><button id='callUs' className='text-white btn btn-primary rounded-lg' href='tel:6195047147' >Call Us <i class="fas fa-phone"></i></button></Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </>
