            ...
            <Navbar className='row' collapseOnSelect fixed='top' expand="lg" bg="white" variant="white">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        <a href='tel:6195047147'><Nav.Link id='callUs' className='ml-2'><button id='callUs' className='text-white btn btn-primary rounded-lg'  >Call Us <i class="fas fa-phone"></i></button></Nav.Link></a>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </>
